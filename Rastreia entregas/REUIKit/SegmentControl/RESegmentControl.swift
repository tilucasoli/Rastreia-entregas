...
// MARK: Delegate
protocol RESegmentControlDelegate: AnyObject {
    func indexDidChange(index: Int)
}

// MARK: Styleable
extension RESegmentControl: Styleable {
    typealias Styles = StylesSegmentControl

    enum StylesSegmentControl: Int {
        case expanded
        case compacted
    }

    internal func applyStyle(_ style: StylesSegmentControl) {
        switch style {
        case .expanded:
            buildLayoutExpanded()
        case .compacted:
